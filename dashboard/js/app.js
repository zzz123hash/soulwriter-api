...
function renderContent() {
  switch (state.currentView) {
    ...
    case 'writing': return '<h2>&#x270F; ' + t('nav.writing') + '</h2><p>写作界面开发中...</p>';
